 ...
 * @author Oscar Luna
 */
public class EditarVuelos extends javax.swing.JFrame implements ActionListener {
    //Aeropuerto
     ...
     */
    public EditarVuelos(VUELO vuelo, Operador vent) {
        initComponents();
        this.vuelo = vuelo;
        this.vent = vent;
        if (vuelo!= null){
      ...
      this.FechaSalida.setDate(fechaDate);
        ...
        Logger.getLogger(EditarVuelos.class.getName()).log(Level.SEVERE, null, ex);
      }
...
VUELO.setEstado_de_vuelo(ESTADO_DE_VUELO.RETRASADO);
this.dispose();
